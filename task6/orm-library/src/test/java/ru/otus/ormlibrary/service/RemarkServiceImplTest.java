...
import ru.otus.ormlibrary.repositories.RemarkRepository;
...
class RemarkServiceImplTest {
    ...
    void shouldReturnAllRemarksByBook() {
        given(remarkRepository.findAllByBook(EXISTING_BOOK_ID1)).willReturn(List.of(existingRemark1, existingRemark2));
