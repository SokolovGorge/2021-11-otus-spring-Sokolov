...
class BookServiceImplTest {
    ...
    private static final String EXISTING_BOOK_ID2 = "b2";
    ...
    private static final String EXISTING_GENRE_ID2 = "g2";
    private static final String EXISTING_GENRE_NAME2 = "Фантастика";
    private static final String EXISTING_AUTHOR_ID2 = "a2";
    ...
    void shouldAddBook() {
        ...
        given(bookRepository.save(new Book(newTitle, existingAUTHOR1, existingGENRE1)))
                .willReturn(newBook);
    ...
    void shouldUpdateBook() {
        ...
        given(bookRepository.saveWithRecursive(new Book(EXISTING_BOOK_ID1, newTitle, existingAUTHOR2, existingGENRE2)))
